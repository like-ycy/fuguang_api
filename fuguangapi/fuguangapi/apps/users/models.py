...
class User(AbstractUser):
    ...
    money = models.DecimalField(max_digits=10, decimal_places=2, default=0.0, verbose_name='余额')
    credit = models.IntegerField(default=0, verbose_name='积分')
    # avatar = models.ImageField(upload_to='avatar/%Y', default='', null=True, verbose_name='头像')
...
class UserCourse(BaseModel):
    ...
    study_time = models.IntegerField(default=0, verbose_name="学习总时长")
